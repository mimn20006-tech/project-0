...
app.use((req, res, next) => {
  ...
  console.log("ORIGIN_CHECK", { method: req.method, path: req.path, origin, allowed: isAllowedOrigin(origin) });
  if (isAllowedOrigin(origin)) return next();
  console.log("ORIGIN_REJECTED", { origin, allowedOrigins });
